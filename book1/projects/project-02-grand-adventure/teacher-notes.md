...
- **Lesson 3 — Milestone 3: explore.**
  ...
  exit, collects items, and always offers a quit branch.
...
- **Lesson 4 — Milestone 4: save and load.**
  ...
  End with a showcase in which students close and reload their adventures.
...
- Fast finishers: add more rooms, a combat method on the existing `Hero` class, a score, or
...
1. **Milestone 1 — Hero (25 points):** one `Hero` class stores the hero's name, health, and
   inventory, and the program creates a hero and displays the starting stats.
2. **Milestone 2 — World (25 points):** the three flat dictionaries preserve the required
   shapes, composite exit keys work, and the starting room description is displayed.
3. **Milestone 3 — Exploration (25 points):** the loop moves through valid exits, reports an
   invalid direction, collects room items, and has a reliable quit branch.
4. **Milestone 4 — Save and load (25 points):** the fixed line layout is written and read in
