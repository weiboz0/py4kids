...
| `transform-each` | Do the same to each (map) | u06 | apply the *same step* to every item, producing a **new sequence** | u07 Ex12 (reuse), u08 Ex14 translate-each (reuse), u09 Ex3 line→int (reuse) |
